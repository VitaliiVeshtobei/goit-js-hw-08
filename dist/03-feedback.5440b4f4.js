...
refs.form.addEventListener("input", (0, _lodashThrottleDefault.default)(onInputCheange, 500));
...
function populateInput() {
    ...
    if (savedMessage) {
        ...
        if (savedMessagePars["email"] !== undefined) refs.input.value = savedMessagePars["email"];
        else refs.input.value = "";
        if (savedMessagePars["message"] !== undefined) refs.textarea.value = savedMessagePars["message"];
